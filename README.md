...
**In the end of this README are instructions to run this tool as an interactive streamlit application**
...
All tools are listed with version in environment.yml file
